...
CREATE OR REPLACE FUNCTION "public"."admin_delete_user"("user_id" "uuid") RETURNS boolean LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."check_asset_availability"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."detect_association_inconsistencies"() RETURNS TABLE(
        "asset_id" "text",
...
SET "search_path" TO 'public' AS $$
DECLARE status_disponivel_id BIGINT;
...
SELECT DISTINCT a.uuid as asset_uuid,
...
FROM assets a
    LEFT JOIN associations assoc ON (
        a.uuid = assoc.equipment_id
        OR a.uuid = assoc.chip_id
    )
...
SELECT DISTINCT CASE
        WHEN assoc.equipment_id IS NOT NULL THEN assoc.equipment_id
        ELSE assoc.chip_id
    END AS asset_uuid,
    a.status_id as current_status,
...
FROM associations assoc
    JOIN assets a ON a.uuid = assoc.equipment_id
    OR a.uuid = assoc.chip_id
...
CREATE OR REPLACE FUNCTION "public"."fix_missing_profiles"() RETURNS TABLE(
        "user_id" "uuid",
        "email" "text",
        "fixed" boolean
    ) LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."has_minimum_role"("required_role" "public"."user_role_enum") RETURNS boolean LANGUAGE "plpgsql" STABLE SECURITY DEFINER
SET "search_path" TO 'public' AS $$
DECLARE user_role user_role_enum;
...
CREATE OR REPLACE FUNCTION "public"."has_role"("role_name" "public"."user_role_enum") RETURNS boolean LANGUAGE "sql" STABLE SECURITY DEFINER
SET "search_path" TO 'public' AS $$
SELECT EXISTS (
        SELECT 1
        FROM profiles
...
CREATE OR REPLACE FUNCTION "public"."is_afiliado"() RETURNS boolean LANGUAGE "sql" STABLE SECURITY DEFINER
SET "search_path" TO 'public' AS $$
SELECT has_role('cliente'::user_role_enum);
$$;
ALTER FUNCTION "public"."is_afiliado"() OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "public"."is_support_or_above"() RETURNS boolean LANGUAGE "sql" STABLE SECURITY DEFINER
SET "search_path" TO 'public' AS $$
SELECT has_minimum_role('suporte'::user_role_enum);
$$;
ALTER FUNCTION "public"."is_support_or_above"() OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "public"."is_user_self"("profile_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER
SET "search_path" TO 'public' AS $$
SELECT profile_id = auth.uid() $$;
ALTER FUNCTION "public"."is_user_self"("profile_id" "uuid") OWNER TO "postgres";
CREATE OR REPLACE FUNCTION "public"."log_and_update_status"() RETURNS "trigger" LANGUAGE "plpgsql"
...
CREATE OR REPLACE FUNCTION "public"."log_asset_insert"() RETURNS "trigger" LANGUAGE "plpgsql"
SET "search_path" TO 'public' AS $$BEGIN
INSERT INTO asset_logs (
        assoc_id,
        date,
...
CREATE OR REPLACE FUNCTION "public"."log_asset_soft_delete"() RETURNS "trigger" LANGUAGE "plpgsql"
SET "search_path" TO '' AS $$
...
- Versão: 1.0 - Refatoração PRD 28/05/2025';
CREATE OR REPLACE FUNCTION "public"."log_asset_status_change"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER
SET "search_path" TO 'public' AS $$DECLARE last_assoc_id BIGINT;
asset_solution_id BIGINT;
-- <--- Adicione isso!
...
CREATE OR REPLACE FUNCTION "public"."log_client_changes"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER
SET "search_path" TO 'public' AS $$
DECLARE user_email TEXT;
safe_user_id UUID;
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."log_profile_change"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER
SET "search_path" TO 'public' AS $$
...
CREATE OR REPLACE FUNCTION "public"."prevent_rented_association"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER
SET "search_path" TO 'public' AS $$
DECLARE current_status_id BIGINT;
...
CREATE OR REPLACE FUNCTION "public"."status_by_asset_type"() RETURNS TABLE("type" "text", "status" "text", "count" bigint) LANGUAGE "plpgsql"
SET "search_path" TO 'public' AS $$ BEGIN RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."update_all_rented_days"() RETURNS "jsonb" LANGUAGE "plpgsql"
SET "search_path" TO 'public, auth' AS $$
DECLARE asset_record record;
...
CREATE OR REPLACE FUNCTION "public"."update_asset_rented_days"("asset_uuid" "text") RETURNS "jsonb" LANGUAGE "plpgsql"
SET "search_path" TO 'public, auth' AS $$
DECLARE current_rented_days integer := 0;
...
CREATE OR REPLACE FUNCTION "public"."update_generic_updated_at_column"() RETURNS "trigger" LANGUAGE "plpgsql"
SET "search_path" TO 'public' AS $$BEGIN NEW.updated_at = NOW();
RETURN NEW;
END;
$$;
...
SET "search_path" TO 'public' AS $$ BEGIN -- Atualizar o last_login no profiles quando o last_sign_in_at for atualizado
...
CREATE OR REPLACE FUNCTION "public"."user_has_profile"("user_id" "uuid") RETURNS boolean LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."validate_association_state"(
        "p_asset_id" "text",
        "p_operation" "text",
        "p_association_id" bigint DEFAULT NULL::bigint
    ) RETURNS "jsonb" LANGUAGE "plpgsql"
SET "search_path" TO 'public, auth' AS $$
DECLARE asset_exists BOOLEAN := FALSE;
...
BEGIN
SELECT status INTO asset_status_name
FROM asset_status
WHERE id = asset_status_id;
...
CREATE OR REPLACE FUNCTION "public"."validate_rented_days_integrity"() RETURNS TABLE(
        "asset_id" "text",
...
ALTER TABLE "public"."association_types"
ALTER COLUMN "id"
...
ALTER COLUMN "id"
SET DEFAULT "nextval"('"public"."asset_history_id_seq"'::"regclass");
ALTER TABLE ONLY "public"."location_types"
ALTER COLUMN "id"
SET DEFAULT "nextval"('"public"."location_types_id_seq"'::"regclass");
ALTER TABLE ONLY "public"."locations"
ALTER COLUMN "id"
SET DEFAULT "nextval"('"public"."locations_id_seq"'::"regclass");
ALTER TABLE ONLY "public"."plans"
ALTER COLUMN "id"
SET DEFAULT "nextval"('"public"."pacotes_id_seq"'::"regclass");
ALTER TABLE ONLY "public"."asset_client_assoc"
...
CREATE INDEX "idx_associations_chip_id" ON "public"."associations" USING "btree" ("chip_id")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_client_id" ON "public"."associations" USING "btree" ("client_id")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_entry_date" ON "public"."associations" USING "btree" ("entry_date")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_equipment_id" ON "public"."associations" USING "btree" ("equipment_id")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_exit_date" ON "public"."associations" USING "btree" ("exit_date")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_plan_id" ON "public"."associations" USING "btree" ("plan_id")
WHERE ("deleted_at" IS NULL);
CREATE INDEX "idx_associations_status_active" ON "public"."associations" USING "btree" ("status")
WHERE ("deleted_at" IS NULL);
...
CREATE OR REPLACE TRIGGER "asset_histories_log_trigger"
AFTER
INSERT
    OR
UPDATE ON "public"."asset_logs" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
...
CREATE OR REPLACE TRIGGER "asset_status_update_history"
AFTER
UPDATE OF "status_id" ON "public"."assets" FOR EACH ROW EXECUTE FUNCTION "public"."log_asset_status_change"();
CREATE OR REPLACE TRIGGER "assets_after_insert"
AFTER
INSERT ON "public"."assets" FOR EACH ROW EXECUTE FUNCTION "public"."log_asset_insert"();
CREATE OR REPLACE TRIGGER "assets_log_trigger"
AFTER
INSERT
    OR DELETE
    OR
UPDATE ON "public"."assets" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
CREATE OR REPLACE TRIGGER "client_changes_trigger"
AFTER
INSERT
    OR DELETE
    OR
UPDATE ON "public"."clients" FOR EACH ROW EXECUTE FUNCTION "public"."log_client_changes"();
CREATE OR REPLACE TRIGGER "client_logs_updated_at_trigger" BEFORE
UPDATE ON "public"."client_logs" FOR EACH ROW EXECUTE FUNCTION "public"."update_generic_updated_at_column"();
CREATE OR REPLACE TRIGGER "clients_log_trigger"
AFTER
INSERT
    OR DELETE
    OR
UPDATE ON "public"."clients" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
CREATE OR REPLACE TRIGGER "handle_bits_referrals_updated_at" BEFORE
UPDATE ON "public"."bits_referrals" FOR EACH ROW EXECUTE FUNCTION "public"."update_generic_updated_at_column"();
CREATE OR REPLACE TRIGGER "handle_bits_rewards_catalog_updated_at" BEFORE
UPDATE ON "public"."bits_rewards_catalog" FOR EACH ROW EXECUTE FUNCTION "public"."update_generic_updated_at_column"();
CREATE OR REPLACE TRIGGER "plans_log_trigger"
AFTER
INSERT
    OR DELETE
    OR
UPDATE ON "public"."plans" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
CREATE OR REPLACE TRIGGER "profiles_log_trigger"
AFTER
INSERT
    OR DELETE
    OR
UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
CREATE OR REPLACE TRIGGER "set_asset_logs_updated_at" BEFORE
UPDATE ON "public"."asset_logs" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_asset_solutions_updated_at" BEFORE
UPDATE ON "public"."asset_solutions" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_asset_status_updated_at" BEFORE
UPDATE ON "public"."asset_status" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_assets_updated_at" BEFORE
UPDATE ON "public"."assets" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_association_types_updated_at" BEFORE
UPDATE ON "public"."association_types" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_badges_catalog_updated_at" BEFORE
UPDATE ON "public"."bits_badges_catalog" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_campaigns_updated_at" BEFORE
UPDATE ON "public"."bits_campaigns" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_levels_catalog_updated_at" BEFORE
UPDATE ON "public"."bits_levels_catalog" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_missions_catalog_updated_at" BEFORE
UPDATE ON "public"."bits_missions_catalog" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_points_log_updated_at" BEFORE
UPDATE ON "public"."bits_points_log" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_referrals_updated_at" BEFORE
UPDATE ON "public"."bits_referrals" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_rewards_catalog_updated_at" BEFORE
UPDATE ON "public"."bits_rewards_catalog" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_user_badges_updated_at" BEFORE
UPDATE ON "public"."bits_user_badges" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_user_missions_updated_at" BEFORE
UPDATE ON "public"."bits_user_missions" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_user_profile_stats_updated_at" BEFORE
UPDATE ON "public"."bits_user_profile_stats" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_bits_user_rewards_updated_at" BEFORE
UPDATE ON "public"."bits_user_rewards" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_clients_updated_at" BEFORE
UPDATE ON "public"."clients" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_location_types_updated_at" BEFORE
UPDATE ON "public"."location_types" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_locations_updated_at" BEFORE
UPDATE ON "public"."locations" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_manufacturers_updated_at" BEFORE
UPDATE ON "public"."manufacturers" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_plans_updated_at" BEFORE
UPDATE ON "public"."plans" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_profile_logs_updated_at" BEFORE
UPDATE ON "public"."profile_logs" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "set_profiles_updated_at" BEFORE
UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
CREATE OR REPLACE TRIGGER "trg_log_asset_soft_delete"
AFTER
UPDATE ON "public"."assets" FOR EACH ROW
    WHEN (
        (
            ("old"."deleted_at" IS NULL)
            AND ("new"."deleted_at" IS NOT NULL)
...
INSERT
    ...
    OR
UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."log_profile_change"();
CREATE OR REPLACE TRIGGER "update_locations_updated_at" BEFORE
UPDATE ON "public"."locations" FOR EACH ROW EXECUTE FUNCTION "public"."update_generic_updated_at_column"();
CREATE OR REPLACE TRIGGER "update_manufacturer_updated_at" BEFORE
UPDATE ON "public"."manufacturers" FOR EACH ROW EXECUTE FUNCTION "public"."update_generic_updated_at_column"();
ALTER TABLE ONLY "public"."asset_client_assoc"
...
ALTER TABLE ONLY "public"."assets"
ADD CONSTRAINT "assets_manufacturer_id_fkey" FOREIGN KEY ("manufacturer_id") REFERENCES "public"."manufacturers"("id") ON UPDATE CASCADE ON DELETE
SET NULL;
ALTER TABLE ONLY "public"."assets"
...
ALTER TABLE ONLY "public"."bits_points_log"
ADD CONSTRAINT "bits_points_log_related_referral_id_fkey" FOREIGN KEY ("related_referral_id") REFERENCES "public"."bits_referrals"("id") ON DELETE
SET NULL;
ALTER TABLE ONLY "public"."bits_points_log"
ADD CONSTRAINT "bits_points_log_related_reward_id_fkey" FOREIGN KEY ("related_reward_id") REFERENCES "public"."bits_rewards_catalog"("id") ON DELETE
SET NULL;
ALTER TABLE ONLY "public"."bits_points_log"
...
ALTER TABLE ONLY "public"."asset_logs"
ADD CONSTRAINT "fk_asset_logs_assoc_id" FOREIGN KEY ("assoc_id") REFERENCES "public"."asset_client_assoc"("id") ON DELETE
SET NULL;
ALTER TABLE ONLY "public"."asset_logs"
...
ALTER TABLE ONLY "public"."locations"
ADD CONSTRAINT "locations_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."clients"("uuid") ON UPDATE CASCADE ON DELETE
SET NULL;
ALTER TABLE ONLY "public"."locations"
...
ALTER TABLE ONLY "public"."asset_status"
ADD CONSTRAINT "status_association_fkey" FOREIGN KEY ("association") REFERENCES "public"."association_types"("id") ON UPDATE CASCADE ON DELETE
SET NULL;
...
INSERT TO "authenticated" WITH CHECK (("referrer_user_id" = "auth"."uid"()));
CREATE POLICY "Clientes can view their own referrals" ON "public"."bits_referrals" FOR
SELECT TO "authenticated" USING (("referrer_user_id" = "auth"."uid"()));
...
SELECT USING ("public"."is_user_self"("id"));

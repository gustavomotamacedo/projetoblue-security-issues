    ...
    try {
      let query = supabase
        ...
        .select(`
          ...
          ssid_fabrica, pass_fabrica, ssid_atual, pass_atual,
      ...
      const asset: SelectedAsset = {
        ...
        carrier: 'Unknown',
        uniqueId: data.uuid,
        ssid_fabrica: data.ssid_fabrica,
        pass_fabrica: data.pass_fabrica,
        ssid_atual: data.ssid_atual,
        pass_atual: data.pass_atual,
        ssid: '#WiFi.LEGAL',
        password: '123legal',
        gb: 0,
        notes: '',

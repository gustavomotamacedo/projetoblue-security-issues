...
export function Footer({ className, ...props }: FooterProps) {
  ...
  return (
    <footer 
      className={cn(
        "h-10 border-t border-border bg-background px-4 flex justify-between items-center text-xs text-text-secondary-dark dark:text-text-secondary-dark z-10 shadow-legal-sm dark:shadow-legal-dark",
        className
      )}
      {...props}
    >
      ...
      <div className="flex items-center gap-3">
        <Button 
          variant="link" 
          size="sm" 
          className="h-auto p-0 text-xs text-legal-primary dark:text-legal-secondary hover:text-legal-primary-light dark:hover:text-legal-secondary-light"
        >
          Ver changelog
        </Button>
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent 
              side="top" 
              className="bg-background border border-legal-primary/20 dark:border-legal-secondary/20 shadow-legal-lg"
            >

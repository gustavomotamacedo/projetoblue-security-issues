...
import { withRetry } from '@/services/errorMapper';
...
const ForgotPassword = () => {
  ...
  // Handle form submission with retry mechanism for the critical operation
  const onSubmit: SubmitHandler<ResetFormValues> = async (data) => {
    if (form.formState.isSubmitting || isLoading) return;
    
    try {
      // Using the retry utility for the critical operation
      await withRetry(

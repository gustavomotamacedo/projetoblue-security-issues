...
import { Asset, AssetType, ChipAsset, RouterAsset, AssetStatus, StatusRecord, Client, SubscriptionInfo } from '@/types/asset';
...
export const useAssetOperations = (
  ...
  // Advanced operations that require the addHistoryEntry function and clients

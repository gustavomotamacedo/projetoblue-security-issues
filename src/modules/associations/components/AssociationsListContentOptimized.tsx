...
import { useAssociationsListOptimized } from '../hooks/useAssociationsListOptimized';
...
export const AssociationsListContentOptimized: React.FC = () => {
  const {
    associationGroups,
    isLoading,
    error,

...
interface SubscriptionAssociationsCardProps {
  totalActive: number;
...
export const SubscriptionAssociationsCard: React.FC<SubscriptionAssociationsCardProps> = ({
  totalActive,
  recentAssets,
  distributionByType,
  isLoading = false
  ...
  return (
    <Card className="h-full flex flex-col hover:shadow-lg transition-shadow duration-300">
      ...
      <CardContent className="flex-1 flex flex-col justify-between space-y-4">
        ...
        <Button 
          onClick={() => navigate('/associations-list?type=assinatura')}
